...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    MO(1),   KC_LOPT, KC_LCMD,                            KC_SPC,                             KC_RCMD, KC_ROPT, MO(1),   KC_LEFT, KC_DOWN, KC_RGHT
  ),
  ...
  [1] = LAYOUT(
    ...
    _______, RGB_HUI, RGB_VAI, RGB_SAI, _______, _______, _______, _______, _______, _______,  KC_MPLY, KC_MPRV, KC_MNXT, RESET,             _______,
